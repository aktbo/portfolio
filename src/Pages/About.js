...
const About = () => {
  return (
    <div className="text-con">
      ...
      <p>
        I was working on a web application for a local company and learned their
        stack quickly and efficiently. I’m passionate about technology - not a
        specific framework or language. In this line of work it's about
        adaptation, and what works best for the project. I’m open to learning
        any stack if it works.
      </p>

      <p>
        My motto as a developer is if I am the smartest person in the room, I am
        in the wrong room. I love learning, and want to become the best
